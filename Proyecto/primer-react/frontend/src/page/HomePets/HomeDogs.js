...
import "./HomePets.css";
import PetsImage1 from "../../components/img/dogs/dogs.jpg";
import PetsImage2 from "../../components/img/dogs/dogs1.jpg";
import PetsImage3 from "../../components/img/dogs/dogs2.jpg";
    ...
    <div className="footer-container">
      <div className="home-container">
        <header className="header">
          <h1>
            <b>Conoce Tus Perrunos Pacientes</b>
          </h1>
        </header>
        <br></br>
